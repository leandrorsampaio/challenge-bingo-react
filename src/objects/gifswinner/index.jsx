...
const Gifswinner = () => {
    ...
    return (
        <>
           ...
           <img className="gifswinner --developerTester" src={require('../../assets/images/winner/developer-tester.gif')} alt="Developer and tester gif" />
           <img className="gifswinner --brazil" src={require('../../assets/images/winner/oi-brazil.gif')} alt="Brazil gif" />
           <img className="gifswinner --spock" src={require('../../assets/images/winner/spock.gif')} alt="Spock gif" />
           <img className="gifswinner --cssKing" src={require('../../assets/images/winner/css2.gif')} alt="CSS King gif" />
           <img className="gifswinner --zebra" src={require('../../assets/images/winner/zebra.gif')} alt="Zebra dancing gif" />
